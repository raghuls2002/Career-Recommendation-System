...
dropdownList = {'Logical quotient rating':[5, 7, 2, 9, 1, 6, 4, 8, 3], 
                ...
                'certifications': ['information security', 'shell programming', 'r programming', 'distro making', 'machine learning', 
                                   'full stack', 'hadoop', 'app development', 'python'], 
                'workshops': ['testing', 'database security', 'game development', 'data science', 'system designing', 
                              'hacking', 'cloud computing', 'web technologies'], 
                'reading and writing skills': ['poor', 'excellent', 'medium'], 
                'memory capability score': ['poor', 'medium', 'excellent'], 
                'Interested subjects': ['programming', 'Management', 'data engineering', 'networks', 'Software Engineering', 
                ...
                'Type of company want to settle in?': ['BPA', 'Cloud Services', 'product development', 'Testing and Maintainance Services', 
                ...
                'Interested Type of Books': ['Series', 'Autobiographies', 'Travel', 'Guide', 'Health', 'Journals', 'Anthology', 'Dictionaries', 
